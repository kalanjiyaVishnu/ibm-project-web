          ...
          <div>
            ...
            <div>
              <h1 className="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">
                Analytics to enrich your online business
              </h1>
              ...
              <div className="mt-8 flex gap-x-4 sm:justify-center">
                <Link href="/analytics">
                  <div className="inline-block rounded-lg bg-indigo-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-indigo-600 hover:bg-indigo-700 hover:ring-indigo-700">
                    Get started
